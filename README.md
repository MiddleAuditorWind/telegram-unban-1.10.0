...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/MiddleAuditorWind/">MiddleAuditorWind</a><a href="https://github.com/MiddleAuditorWind/telegram-unban-1.10.0">/telegram-unban-1.10.0</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `MiddleAuditorWind/telegram-unban-1.10.0`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/issues/522)
...
- См. [#765](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/discussions/251)
...
- См. также [#252](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/MiddleAuditorWind/telegram-unban-1.10.0/blob/main/LICENSE.txt)
